...
path = sys.argv[1]
if ("XXX" not in path) | (not os.path.isdir(path)):
...
[prefix, suffix] = data_base.split('XXX', 1)
triangle_name = prefix + '400Vs' + suffix
uncorrelated_name = prefix + 'uncorrelated_100k' + suffix
