...
import numpy as np
from glmnet_python import glmnetSet
import h5py
...
print(np.shape(vg.Voltammogram))
data = voltammetry.PreprocessedData(vg.Voltammogram[160:1160,:,:], labels,window_size=425,trainingSampleSize=125)
